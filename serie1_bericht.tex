...
Für die Funktion $g_1:[\pi, 3\pi] \rightarrow \mathbb{R}$ mit $g_1(x)= sin(x)/x$ war zu beobachten, dass für eine kleinere Schrittweite $h$ die Approximation der Ableitungen immer genauer wurde. Dies lässt sich so erklären, da wir die Stelle,
