...
{
  \centering
    \includegraphics[width=0.32\textwidth]{Grafiken/Funktionenplot_j1_Pi_Zehntel}
    \includegraphics[width=0.32\textwidth]{Grafiken/Funktionenplot_j075_Pi_Zehntel}
    \includegraphics[width=0.32\textwidth]{Grafiken/Funktionenplot_j05_Pi_Zehntel}\\
    \includegraphics[width=0.32\textwidth]{Grafiken/Funktionenplot_j025_Pi_Zehntel}
    \includegraphics[width=0.32\textwidth]{Grafiken/Funktionenplot_j01_Pi_Zehntel}
    \includegraphics[width=0.32\textwidth]{Grafiken/Funktionenplot_j001_Pi_Zehntel}\\
    \captionof{figure}{$g_1$ für $j<1$.}

    \vspace{0.5cm}
    \includegraphics[width=0.32\textwidth]{Grafiken/Funktionenplot_j1_Pi_Zehntel}
    \includegraphics[width=0.32\textwidth]{Grafiken/Funktionenplot_j2_Pi_Zehntel}
    \includegraphics[width=0.32\textwidth]{Grafiken/Funktionenplot_j4_Pi_Zehntel}\\
    \includegraphics[width=0.32\textwidth]{Grafiken/Funktionenplot_j8_Pi_Zehntel}
    \includegraphics[width=0.32\textwidth]{Grafiken/Funktionenplot_j16_Pi_Zehntel}\\
    \captionof{figure}{$g_1$ für $j>1$.}
  }
